...
-- Started on 2025-06-27 13:32:57
...
--
-- TOC entry 261 (class 1255 OID 24761)
-- Name: get_pivoted_lib_titles(integer); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.get_pivoted_lib_titles(prj integer) RETURNS TABLE(lib_titles text[])
    LANGUAGE plpgsql
    AS $$
DECLARE
    col_list TEXT;
...
BEGIN
    ...
    SELECT string_agg(
        format('MAX(CASE WHEN lib_id = %s THEN lib_title END)', lib_id),
        ', '
    )
    INTO col_list
    FROM (
    ...
    -- Construct SQL to return as array (or individual columns if preferred)
    dyn_sql := format('SELECT ARRAY[%s] FROM libtbl2025 WHERE prj_id = %s;', col_list, prj);
...
ALTER FUNCTION public.get_pivoted_lib_titles(prj integer) OWNER TO postgres;
...
--
-- TOC entry 249 (class 1259 OID 24749)
-- Name: cols; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.cols OWNER TO postgres;
...
--
-- TOC entry 241 (class 1259 OID 24704)
...
--
-- TOC entry 240 (class 1259 OID 24703)
...
--
-- TOC entry 243 (class 1259 OID 24713)
...
--
-- TOC entry 232 (class 1259 OID 24667)
...
--
-- TOC entry 233 (class 1259 OID 24672)
...
-- Name: testlib; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.testlib (
    lib_id integer NOT NULL,
    lib_title character varying,
    lib_allot integer,
    lib_fnd character varying
);


ALTER TABLE public.testlib OWNER TO postgres;

--
-- TOC entry 247 (class 1259 OID 24742)
-- Name: testlib_lib_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.testlib_lib_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.testlib_lib_id_seq OWNER TO postgres;

--
-- TOC entry 5060 (class 0 OID 0)
-- Dependencies: 247
-- Name: testlib_lib_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.testlib_lib_id_seq OWNED BY public.testlib.lib_id;
...
--
-- TOC entry 4839 (class 2604 OID 24636)
...
--
-- TOC entry 4840 (class 2604 OID 24645)
...
--
-- TOC entry 4847 (class 2604 OID 24707)
...
--
-- TOC entry 4841 (class 2604 OID 24654)
...
--
-- TOC entry 4831 (class 2604 OID 24627)
...
--
-- TOC entry 4848 (class 2604 OID 24716)
...
--
-- TOC entry 4842 (class 2604 OID 24661)
...
--
-- TOC entry 4843 (class 2604 OID 24673)
...
--
-- TOC entry 4844 (class 2604 OID 24682)
...
--
-- TOC entry 4846 (class 2604 OID 24698)
...
--
-- TOC entry 4849 (class 2604 OID 24746)
-- Name: testlib lib_id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.testlib ALTER COLUMN lib_id SET DEFAULT nextval('public.testlib_lib_id_seq'::regclass);


--
-- TOC entry 4845 (class 2604 OID 24691)
...
--
-- TOC entry 4830 (class 2604 OID 24581)
...
--
-- TOC entry 5021 (class 0 OID 24630)
-- Dependencies: 224
...
17	Other Personnel Benefits - SRI	\N	\N	1A1	PS	2024
18	Collective Negotiation Agreement (CNA)	\N	\N	1A1	PS	2024
19	Loyalty	\N	5000	1A1	PS	2024
26	Pension and Gratuity Fund	\N	\N	1A1	PS	2024
28	Monetization of Leave Credits	\N	\N	1A1	PS	2024
95	Collective Negotiation Agreement (CNA)	\N	\N	2A1-2	PS	2024
268	Step Increment	\N	29000	2A2	PS	2025
269	Emp. Comp. Insurance Prem.	50103040-01	25000	2A2	PS	2025
270	Loyalty Award	\N	35000	2A2	PS	2025
271	Subsistence Allowance	50102050-02	832000	2A2	PS	2025
272	Laundry Allowance	50102060-03	126000	2A2	PS	2025
273	Hazard Pay	50102110-04	1724000	2A2	PS	2025
274	Longevity Pay	50102120-03	858000	2A2	PS	2025
275	Local Travel	50201010-00	310000	2A2	MOOE	2025
276	Foreign Travel	50201020-00	50000	2A2	MOOE	2025
277	Training Expenses	50202010-02	66859000	2A2	MOOE	2025
278	Office Supplies  Expenses	50203010-02	250000	2A2	MOOE	2025
279	Fuel, Oil and Lubricants Expenses	50203090-00	450000	2A2	MOOE	2025
280	Other Supplies & Materials Expenses	50203990-00	350000	2A2	MOOE	2025
281	Electricity Expenses	50204020-00	700000	2A2	MOOE	2025
282	Telephone (Mobile)	50205020-01	60000	2A2	MOOE	2025
283	Telephone ( Landline)	50205020-02	260000	2A2	MOOE	2025
284	Postage and Courier Expenses	50205010-00	70000	2A2	MOOE	2025
285	Local Travel	50201010-00	10000	3A1	MOOE	2025
286	Office Supplies  Expenses	50203010-02	80000	3A1	MOOE	2025
287	Other Supplies & Materials Expenses	50203990-00	106000	3A1	MOOE	2025
288	Telephone (Mobile)	50205020-01	20000	3A1	MOOE	2025
289	Postage and Courier Expenses	50205010-00	10000	3A1	MOOE	2025
290	Other Professional Services	50211990-00	1170000	3A1	MOOE	2025
291	Printing & Publication Expenses	50299020-00	20000	3A1	MOOE	2025
292	Representation Expenses	50299030-00	30000	3A1	MOOE	2025
293	RLIP	50103010-00	1387000	1A1	PS	2025
294	RLIP	50103010-00	368000	2A1-1	PS	2025
295	RLIP	50103010-00	524000	2A1-2	PS	2025
296	RLIP	50103010-00	1416000	2A2	PS	2025
9	Mid-Year Bonus	50102160-01	963000	1A1	PS	2024
54	Capital Outlay	\N	\N	1A1	CO	2024
156	Productivity Enhancement Incentive	50102990-12	95000	1A1	PS	2025
157	Year-End Bonus	50102140-01	963000	1A1	PS	2025
158	Cash Gift	50102150-01	95000	1A1	PS	2025
159	Mid-Year Bonus	50102160-01	963000	1A1	PS	2025
160	Pag-IBIG Contributions	50103020-01	46000	1A1	PS	2025
161	PhilHealth Contibutions	50103030-01	263000	1A1	PS	2025
162	Emp. Comp. Insurance Prem.	50103040-01	23000	1A1	PS	2025
163	Step Increment	\N	29000	1A1	PS	2025
164	Personnel Services (Unprogrammed Appro)	50100000-00	\N	1A1	PS	2025
165	Other Personnel Benefits -Anniversarry Bonus	50102990-38	\N	1A1	PS	2025
166	Other Personnel Benefits - SRI	\N	\N	1A1	PS	2025
167	Collective Negotiation Agreement (C.N.A.)	\N	\N	1A1	PS	2025
168	Loyalty	\N	15000	1A1	PS	2025
169	Terminal Leave Benefits	\N	\N	1A1	PS	2025
170	Subsistence Allowance	50102050-02	713000	1A1	PS	2025
171	Laundry Allowance	50102060-03	108000	1A1	PS	2025
172	Hazard Pay	50102110-04	1692000	1A1	PS	2025
173	Longevity Pay	50102120-03	679000	1A1	PS	2025
174	Mutual Personel Benefit Fund  (MPBF) PBB	50102990-14	\N	1A1	PS	2025
175	Unprogrammed MPBF	50104030-01	\N	1A1	PS	2025
176	Local Travel	50201010-00	200000	1A1	MOOE	2025
177	Foreign Travel	50201020-00	60000	1A1	MOOE	2025
178	ICT Training Expenses	50202010-01	50000	1A1	MOOE	2025
179	Office Supplies Expenses	50203010-02	200000	1A1	MOOE	2025
180	Office Supplies  Expenses-ICT Supplies	50203010-01	1100000	1A1	MOOE	2025
181	Fuel, Oil and Lubricants Expenses	50203090-00	426000	1A1	MOOE	2025
182	Other Supplies & Materials Expenses	50203990-00	450000	1A1	MOOE	2025
183	Water Expenses	50204010-00	300000	1A1	MOOE	2025
184	Electricity Expenses	50204020-00	1500000	1A1	MOOE	2025
185	Postage and Courier Expenses	50205010-00	30000	1A1	MOOE	2025
186	Telephone (Mobile)	50205020-01	200000	1A1	MOOE	2025
187	Telephone ( Landline)	50205020-02	240000	1A1	MOOE	2025
188	Internet Subscription Expenses	50205030-00	3800000	1A1	MOOE	2025
189	Buildings & Other  Structures	50213040-01	50000	1A1	MOOE	2025
190	Motor Vehicles	50213060-01	570000	1A1	MOOE	2025
191	Office Equipment, Furnitures & Fixtures	50213050-02	50000	1A1	MOOE	2025
192	Extraordinary Expenses and Miscellaneous Expenses	50210030-00	136000	1A1	MOOE	2025
193	Other Professional Services	50211990-00	100000	1A1	MOOE	2025
194	Janitorial Services	50212020-00	1400000	1A1	MOOE	2025
195	Security Services	50212030-00	1500000	1A1	MOOE	2025
196	Other General Services	50212990-99	50000	1A1	MOOE	2025
197	Fidelity Bond Premiums	50215020-00	800000	1A1	MOOE	2025
198	 Insurance Expenses	50215030-00	400000	1A1	MOOE	2025
199	ICT Software Subscription	50299070-01	4500000	1A1	MOOE	2025
200	Other Subscription Expenses	50299070-99	30000	1A1	MOOE	2025
202	Personnel Econ. Relief Allowance  (PERA)	50102010-01	144000	2A1-1	PS	2025
203	Clothing/Uniform Allowance	50102040-01	42000	2A1-1	PS	2025
204	Productivity Enhancement Incentive	50102990-12	30000	2A1-1	PS	2025
205	Year-End Bonus	50102140-01	256000	2A1-1	PS	2025
206	Cash Gift	50102150-01	30000	2A1-1	PS	2025
207	Mid-Year Bonus	50102160-01	256000	2A1-1	PS	2025
208	Pag-IBIG Contributions	50103020-01	14000	2A1-1	PS	2025
209	PhilHealth Contibutions	50103030-01	77000	2A1-1	PS	2025
210	Emp. Comp. Insurance Prem.	50103040-01	7000	2A1-1	PS	2025
211	Step Increment	\N	8000	2A1-1	PS	2025
...
201	Salaries and Wages - Regular	50101010-01	3067000	2A1-1	PS	2025
...
13	Step Increment	\N	\N	1A1	PS	2024
...
212	Subsistence Allowance	50102050-02	158000	2A1-1	PS	2025
213	Laundry Allowance	50102060-03	24000	2A1-1	PS	2025
214	Hazard Pay	50102110-04	311000	2A1-1	PS	2025
215	Longevity Pay	50102120-03	149000	2A1-1	PS	2025
216	Local Travel	50201010-00	210000	2A1-1	MOOE	2025
217	Foreign Travel	50201020-00	30000	2A1-1	MOOE	2025
218	ERDT	50202020-00	822000000	2A1-1	MOOE	2025
219	ASTHRDP	50202020-00	1424309000	2A1-1	MOOE	2025
220	CBPSME	50202020-00	545000000	2A1-1	MOOE	2025
221	HRDP	50202020-00	56000000	2A1-1	MOOE	2025
222	Office Supplies  Expenses	50203010-02	110000	2A1-1	MOOE	2025
223	Fuel, Oil and Lubricants Expenses	50203090-00	300000	2A1-1	MOOE	2025
224	Other Supplies & Materials Expenses	50203990-00	240000	2A1-1	MOOE	2025
225	Electricity Expenses	50204020-00	600000	2A1-1	MOOE	2025
226	Postage and Courier Expenses	50205010-00	30000	2A1-1	MOOE	2025
227	Telephone (Mobile)	50205020-01	60000	2A1-1	MOOE	2025
228	Telephone ( Landline)	50205020-02	70000	2A1-1	MOOE	2025
229	Salaries and Wages - Regular	50101010-01	4368000	2A1-2	PS	2025
230	Personnel Econ. Relief Allowance  (PERA)	50102010-01	168000	2A1-2	PS	2025
231	Representation Allowance (RA)	50102020-00	72000	2A1-2	PS	2025
232	Transportation Allowance (TA)	50102030-01	72000	2A1-2	PS	2025
233	Clothing/Uniform Allowance	50102040-01	49000	2A1-2	PS	2025
234	Productivity Enhancement Incentive	50102990-12	35000	2A1-2	PS	2025
235	Year-End Bonus	50102140-01	364000	2A1-2	PS	2025
236	Cash Gift	50102150-01	35000	2A1-2	PS	2025
237	Mid-Year Bonus	50102160-01	364000	2A1-2	PS	2025
238	Pag-IBIG Contributions	50103020-01	17000	2A1-2	PS	2025
239	PhilHealth Contibutions	50103030-01	109000	2A1-2	PS	2025
240	Emp. Comp. Insurance Prem.	50103040-01	23000	2A1-2	PS	2025
241	Step Increment	\N	11000	2A1-2	PS	2025
242	Subsistence Allowance	50102050-02	356000	2A1-2	PS	2025
243	Laundry Allowance	50102060-03	54000	2A1-2	PS	2025
244	Hazard Pay	50102110-04	805000	2A1-2	PS	2025
245	Longevity Pay	50102120-03	400000	2A1-2	MOOE	2025
246	Local Travel	50201010-00	210000	2A1-2	MOOE	2025
247	Foreign Travel	50201020-00	60000	2A1-2	MOOE	2025
248	Training Expenses	\N	\N	2A1-2	MOOE	2025
249	Scholarship Expenses	50202020-00	4464496000	2A1-2	MOOE	2025
250	Office Supplies  Expenses	50203010-02	110000	2A1-2	MOOE	2025
251	Fuel, Oil and Lubricants Expenses	50203090-00	300000	2A1-2	MOOE	2025
252	Other Supplies & Materials Expenses	50203990-00	120000	2A1-2	MOOE	2025
253	Electricity Expenses	50204020-00	700000	2A1-2	MOOE	2025
254	Postage and Courier Expenses	50205010-00	50000	2A1-2	MOOE	2025
255	Telephone (Mobile)	50205020-01	110000	2A1-2	MOOE	2025
256	Telephone ( Landline)	50205020-02	90000	2A1-2	MOOE	2025
257	Salaries and Wages - Regular	50101010-01	11798000	2A2	PS	2025
258	Personnel Econ. Relief Allowance  (PERA)	50102010-01	504000	2A2	PS	2025
259	Representation Allowance (RA)	50102020-00	144000	2A2	PS	2025
260	Transportation Allowance (TA)	50102030-01	144000	2A2	PS	2025
261	Clothing/Uniform Allowance	50102040-01	147000	2A2	PS	2025
262	Productivity Enhancement Incentive	50102990-12	105000	2A2	PS	2025
263	Year-End Bonus	50102140-01	983000	2A2	PS	2025
264	Cash Gift	50102150-01	105000	2A2	PS	2025
265	Mid-Year Bonus	50102160-01	983000	2A2	PS	2025
266	Pag-IBIG Contributions	50103020-01	50000	2A2	PS	2025
267	PhilHealth Contibutions	50103030-01	295000	2A2	PS	2025
\.
...
COPY public.cols (string_agg) FROM stdin;
"Contract of Service Personnel" INT, "Honorarium / Service Fees / Incentives for Resources Speakers" INT, "Culture & Athletic Activities" INT, "Health & Wellness Activities" INT, "Training Expenses (In-House & Individual Training/Workshops/ Seminars/Meetings) & Other Related Activities" INT, "Tuition fees, Stipend and Book and Thesis Allowances" INT, "ISO & Philippine Quality Assurance Certification and Other related activities" INT, "Rent Expense (venue for meetings/workshops/seminars)" INT, "Traveling / Transportation Expenses / Courier" INT, "Supplies & Materials" INT, "Representation Expenses" INT, "Program on Awards and Incentives for Service Excellence (PRAISE) Implementation" INT, "Professional Services (Notarization, Psycho & Drug Test)" INT, "Promotional Materials" INT, "Courier/delivery Expense" INT, "One unit multi functional printer" INT
\.
...
COPY public.libtbl2025 (lib_id, prj_id, lib_class, lib_title, lib_allot, prj_fundsource, year) FROM stdin;
1	1	PS	Contract of Service Personnel	85000000	2A1-AC HR	2025
2	1	PS	Honorarium / Service Fees / Incentives for Resources Speakers	250000	2A1-AC HR	2025
3	1	MOOE	Culture & Athletic Activities	1300000	2A1-AC HR	2025
5	1	MOOE	Training Expenses (In-House & Individual Training/Workshops/ Seminars/Meetings) & Other Related Activities	1750000	2A1-AC HR	2025
6	1	MOOE	Tuition fees, Stipend and Book and Thesis Allowances	960000	2A1-AC HR	2025
7	1	MOOE	ISO & Philippine Quality Assurance Certification and Other related activities	200000	2A1-AC HR	2025
8	1	MOOE	Rent Expense (venue for meetings/workshops/seminars)	330000	2A1-AC HR	2025
9	1	MOOE	Traveling / Transportation Expenses / Courier	250000	2A1-AC HR	2025
10	1	MOOE	Supplies & Materials	900000	2A1-AC HR	2025
11	1	MOOE	Representation Expenses	500000	2A1-AC HR	2025
12	1	MOOE	Program on Awards and Incentives for Service Excellence (PRAISE) Implementation	600000	2A1-AC HR	2025
13	1	MOOE	Professional Services (Notarization, Psycho & Drug Test)	100000	2A1-AC HR	2025
14	1	MOOE	Promotional Materials	500000	2A1-AC HR	2025
15	1	MOOE	Courier/delivery Expense	10000	2A1-AC HR	2025
16	1	CO	One unit multi functional printer	50000	2A1-AC HR	2025
17	2	MOOE	Other Supplies and Materials and Expenses	1370000	2A1-AC FAD	2025
18	2	MOOE	Other Maintenance and Operation Expenses	3700000	2A1-AC FAD	2025
19	2	CO	Four (4) Inverter type air conditioning units with installation	930000	2A1-AC FAD	2025
20	3	PS	Honoraria	70000	2A1-AC IPU	2025
21	3	MOOE	Lease Expenses	450000	2A1-AC IPU	2025
22	3	MOOE	Supplies and Materials 	140000	2A1-AC IPU	2025
23	3	MOOE	Travelling Expenses	30000	2A1-AC IPU	2025
24	3	CO	ICT Equipment	110000	2A1-AC IPU	2025
4	1	MOOE	Health & Wellness Activities	1300000	2A1-AC HR	2025
25	4	MOOE	Office Supplies Expenses	150000	2A1-106	2025
26	4	MOOE	Other MOOE	5000	2A1-106	2025
27	4	MOOE	Representation Expenses	60000	2A1-106	2025
28	4	MOOE	Communication Expenses (Telephone)	30000	2A1-106	2025
29	4	MOOE	Travel Expenses (Local)	50000	2A1-106	2025
30	4	MOOE	Advertising Expenses	5000	2A1-106	2025
31	4	MOOE	Scholarship Grants / Expenses	55420000	2A1-106	2025
32	4	MOOE	Rent / Lease Expenses	280000	2A1-106	2025
33	5	PS	Honoraria	2000000	2A1-101 PATRIOT	2025
34	5	MOOE	Scholars Leadership Camp for Undergraduate Scholars	41915300	2A1-101 PATRIOT	2025
35	5	MOOE	Scholars Leadership Camp for Graduate Scholars	5636400	2A1-101 PATRIOT	2025
36	5	MOOE	Scholars Technopreneur Training Program	64540200	2A1-101 PATRIOT	2025
37	5	MOOE	Research Workshop for Graduate Scholars	1791500	2A1-101 PATRIOT	2025
38	5	MOOE	Research Conference for Undergraduate Scholars	6523250	2A1-101 PATRIOT	2025
39	5	MOOE	National Patriot Scholars Congress	15380900	2A1-101 PATRIOT	2025
40	5	MOOE	Funding of Scholars' Community Development Project Proposals and Patriot-Related Activities	3000000	2A1-101 PATRIOT	2025
41	5	MOOE	Representation Expenses 	250000	2A1-101 PATRIOT	2025
42	5	MOOE	Supplies and Materials 	362450	2A1-101 PATRIOT	2025
43	6	MOOE	Tuition and other school fees	183000000	2A1-102	2025
44	6	MOOE	Stipends	1313360000	2A1-102	2025
45	6	MOOE	Learning materials and /or connectivity allowance	164170000	2A1-102	2025
46	6	MOOE	PE / MS Uniform Allowance	4000000	2A1-102	2025
47	6	MOOE	Actual transportation expense per scholar	5047750	2A1-102	2025
48	6	MOOE	Financial Assistance during summer	17576000	2A1-102	2025
49	6	MOOE	Group Accident Insurance	10095500	2A1-102	2025
50	6	MOOE	Thesis Allowance	35480000	2A1-102	2025
51	6	MOOE	Post Graduate Allowance	3548000	2A1-102	2025
52	6	MOOE	STLAP	7408000	2A1-102	2025
53	6	MOOE	Dissemination Grant	2000000	2A1-102	2025
54	7	PS	Honoraria	67000	2A2A-103	2025
55	7	MOOE	Local Travel	150000	2A2A-103	2025
56	7	MOOE	Office supplies expenses	130000	2A2A-103	2025
57	7	MOOE	Drugs and Medicines Expenses	5000	2A2A-103	2025
58	7	MOOE	Other Supplies and Materials	1270000	2A2A-103	2025
59	7	MOOE	Postage and Courier Expenses	150000	2A2A-103	2025
60	7	MOOE	Consultancy Services	720000	2A2A-103	2025
61	7	MOOE	Representation Expenses	650000	2A2A-103	2025
62	7	MOOE	Other Maintenance and Operating Expenses	2000	2A2A-103	2025
63	7	MOOE	Rents - Building and Structures (Venue)	466000	2A2A-103	2025
64	7	MOOE	Rents - Motor Vehicles (Van Rentals)	150000	2A2A-103	2025
65	7	MOOE	Desktop Computer with Accessories	200000	2A2A-103	2025
66	7	MOOE	Two (2)  Units Desktop Printer	40000	2A2A-103	2025
\.


--
-- TOC entry 5025 (class 0 OID 24648)
-- Dependencies: 228
...
1903	DOC-2025-2791	04-0845	1902
1904	DOC-2025-2792	06-9999	1903
1905	DOC-2025-2795	null	1904
\.


--
-- TOC entry 5019 (class 0 OID 24614)
-- Dependencies: 222
...
4084	DOC-2025-2793	\N	2704	\N	\N	\N	100000		50202020-00	2A1-AC FAD	122	0	2793	2025-06-09 07:59:11	\N	\N	FAD			1	0	0	FAD	0	0	0
...
4085	DOC-2025-2794	\N	2704	\N	\N	\N	100000		50202020-00	2A1-AC HR	122	0	2793	2025-06-09 07:59:11	\N	\N	FAD			1	0	0	FAD	0	0	0
4086	DOC-2025-2795	\N	2704	\N	\N	\N	100000		50202020-00	2A1-AC IPU	122	0	2793	2025-06-09 07:59:11	\N	\N	FAD			1	0	0	FAD	0	0	0
3104	DOC-2025-2084	01-0137	3498	\N	\N	\N	3600	\N	50103020 (732)	1A1	999	1	2084	2025-04-10 03:45:42	2025-04-10 03:45:42	\N	FAD	\N	\N	1	0	0	FAD	0	0	0
...
3093	DOC-2025-2078	01-0131	1045	\N	\N	\N	3880.13	\N	50212990-99	1A1	999	1	2078	2025-04-10 03:45:42	2025-04-10 03:45:42	\N	FAD	\N	\N	1	0	0	FAD	0	0	0
...
4079	DOC-2025-2788	04-0841	3483	\N	\N	25	46028	\N	50202020-00	2A1-106	999	1	2788	2025-04-10 03:45:42	2025-04-10 03:45:42	\N	FAD	\N	\N	1	0	0	FAD	0	0	0
3105	DOC-2025-2084	01-0137	3498	\N	\N	\N	800	\N	50103020 (732)	2A1-1	999	1	2084	2025-04-10 03:45:42	2025-04-10 03:45:42	\N	FAD	\N	\N	1	0	0	FAD	0	0	0
3106	DOC-2025-2084	01-0137	3498	\N	\N	\N	2200	\N	50103020 (732)	2A1-2	999	1	2084	2025-04-10 03:45:42	2025-04-10 03:45:42	\N	FAD	\N	\N	1	0	0	FAD	0	0	0
3107	DOC-2025-2084	01-0137	3498	\N	\N	\N	2600	\N	50103020 (732)	2A2-A	999	1	2084	2025-04-10 03:45:42	2025-04-10 03:45:42	\N	FAD	\N	\N	1	0	0	FAD	0	0	0
3108	DOC-2025-2084	01-0137	3498	\N	\N	\N	2200	\N	50103020 (732)	2A2-B	999	1	2084	2025-04-10 03:45:42	2025-04-10 03:45:42	\N	FAD	\N	\N	1	0	0	FAD	0	0	0
3069	DOC-2025-2067	01-0120	3279	\N	\N	\N	115352.4	\N	50103010 (731)	1A1	999	1	2067	2025-04-10 03:45:42	2025-04-10 03:45:42	\N	FAD	\N	\N	1	0	0	FAD	0	0	0
3070	DOC-2025-2067	01-0120	3279	\N	\N	\N	21767.16	\N	50103010 (731)	2A1-1	999	1	2067	2025-04-10 03:45:42	2025-04-10 03:45:42	\N	FAD	\N	\N	1	0	0	FAD	0	0	0
3071	DOC-2025-2067	01-0120	3279	\N	\N	\N	60162.84	\N	50103010 (731)	2A1-2	999	1	2067	2025-04-10 03:45:42	2025-04-10 03:45:42	\N	FAD	\N	\N	1	0	0	FAD	0	0	0
3072	DOC-2025-2067	01-0120	3279	\N	\N	\N	71524.32	\N	50103010 (731)	2A2-A	999	1	2067	2025-04-10 03:45:42	2025-04-10 03:45:42	\N	FAD	\N	\N	1	0	0	FAD	0	0	0
3073	DOC-2025-2067	01-0120	3279	\N	\N	\N	67486.56	\N	50103010 (731)	2A2-B	999	1	2067	2025-04-10 03:45:42	2025-04-10 03:45:42	\N	FAD	\N	\N	1	0	0	FAD	0	0	0
3074	DOC-2025-2067	01-0120	3279	\N	\N	\N	1800	\N	50103040 (734)	1A1	999	1	2067	2025-04-10 03:45:42	2025-04-10 03:45:42	\N	FAD	\N	\N	1	0	0	FAD	0	0	0
3075	DOC-2025-2067	01-0120	3279	\N	\N	\N	400	\N	50103040 (734)	2A1-1	999	1	2067	2025-04-10 03:45:42	2025-04-10 03:45:42	\N	FAD	\N	\N	1	0	0	FAD	0	0	0
3076	DOC-2025-2067	01-0120	3279	\N	\N	\N	1000	\N	50103040 (734)	2A1-2	999	1	2067	2025-04-10 03:45:42	2025-04-10 03:45:42	\N	FAD	\N	\N	1	0	0	FAD	0	0	0
3077	DOC-2025-2067	01-0120	3279	\N	\N	\N	1200	\N	50103040 (734)	2A2-A	999	1	2067	2025-04-10 03:45:42	2025-04-10 03:45:42	\N	FAD	\N	\N	1	0	0	FAD	0	0	0
3078	DOC-2025-2067	01-0120	3279	\N	\N	\N	1100	\N	50103040 (734)	2A2-B	999	1	2067	2025-04-10 03:45:42	2025-04-10 03:45:42	\N	FAD	\N	\N	1	0	0	FAD	0	0	0
3020	DOC-2025-2028	01-0081	3483	\N	\N	\N	22705.24	\N	50102110-04	1A1	999	1	2028	2025-04-10 03:45:42	2025-04-10 03:45:42	\N	FAD	\N	\N	1	0	0	FAD	0	0	0
2934	DOC-2025-1971	01-0024	3483	\N	\N	\N	54577.54	\N	50102120-03	1A1	999	1	1971	2025-04-10 03:45:42	2025-04-10 03:45:42	\N	FAD	\N	\N	1	0	0	FAD	0	0	0
2935	DOC-2025-1971	01-0024	3483	\N	\N	\N	10572.15	\N	50102120-03	2A1-1	999	1	1971	2025-04-10 03:45:42	2025-04-10 03:45:42	\N	FAD	\N	\N	1	0	0	FAD	0	0	0
2936	DOC-2025-1971	01-0024	3483	\N	\N	\N	25069.75	\N	50102120-03	2A1-2	999	1	1971	2025-04-10 03:45:42	2025-04-10 03:45:42	\N	FAD	\N	\N	1	0	0	FAD	0	0	0
2937	DOC-2025-1971	01-0024	3483	\N	\N	\N	62601.7	\N	50102120-03	2A2	999	1	1971	2025-04-10 03:45:42	2025-04-10 03:45:42	\N	FAD	\N	\N	1	0	0	FAD	0	0	0
...
4082	DOC-2025-2791	04-0845	1091	\N	\N	2	8836	\N	50202010-02	2A2B-105	999	1	2791	2025-04-10 03:45:42	2025-06-02 09:18:20	\N	FAD	\N	\N	1	0	0	FAD	0	0	0
4080	DOC-2025-2789	04-0842	3483	\N	\N	31	51232.5	\N	50202020-00	2A1-106	999	1	2789	2025-04-10 03:45:42	2025-04-10 03:45:42	\N	FAD	\N	\N	1	0	0	FAD	0	0	0
4083	DOC-2025-2792	06-9999	1	\N	\N	\N	121		10405020-00	1A1	999	1	2792	2025-05-29 08:45:29	2025-06-09 07:58:04	\N	FAD			1	0	0	FAD	0	0	0
...
--
-- TOC entry 5027 (class 0 OID 24655)
-- Dependencies: 230
...
--
-- TOC entry 5029 (class 0 OID 24667)
-- Dependencies: 232
...
--
-- TOC entry 5031 (class 0 OID 24676)
-- Dependencies: 234
...
--
-- TOC entry 5036 (class 0 OID 24695)
-- Dependencies: 239
...
-- Dependencies: 248
-- Data for Name: testlib; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.testlib (lib_id, lib_title, lib_allot, lib_fnd) FROM stdin;
\.


--
-- TOC entry 5033 (class 0 OID 24685)
-- Dependencies: 236
...
--
-- TOC entry 5018 (class 0 OID 24578)
-- Dependencies: 221
...
SELECT pg_catalog.setval('public.orstbl2023_ors_id_seq', 4084, true);
...
-- Dependencies: 247
-- Name: testlib_lib_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.testlib_lib_id_seq', 1, false);
...
--
-- TOC entry 4855 (class 2606 OID 24638)
...
--
-- TOC entry 4857 (class 2606 OID 24647)
...
--
-- TOC entry 4869 (class 2606 OID 24711)
...
--
-- TOC entry 4853 (class 2606 OID 24629)
...
--
-- TOC entry 4871 (class 2606 OID 24718)
...
--
-- TOC entry 4861 (class 2606 OID 24675)
...
--
-- TOC entry 4863 (class 2606 OID 24684)
...
--
-- TOC entry 4867 (class 2606 OID 24702)
...
--
-- TOC entry 4851 (class 2606 OID 24585)
...
-- Completed on 2025-06-27 13:32:57
